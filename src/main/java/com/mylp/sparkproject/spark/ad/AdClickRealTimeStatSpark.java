...
import com.mylp.sparkproject.domain.AdBlacklist;
	...
	private static JavaPairDStream<String, String> filterByBlacklist(
		...
		JavaPairDStream<String, String> filteredAdRealTimeLogDStream = adRealTimeLogDStream.transformToPair(
				new Function<JavaRDD<ConsumerRecord<String,String>>, JavaPairRDD<String,String>>() {
					...
					@Override
					public JavaPairRDD<String, String> call(JavaRDD<ConsumerRecord<String, String>> rdd)
							throws Exception {
						...
						JavaPairRDD<Long, Boolean> blacklistRDD = javaSparkContext.parallelizePairs(tuples);
						
						JavaPairRDD<Long, ConsumerRecord<String, String>> mappedRDD = rdd.mapToPair(
								new PairFunction<ConsumerRecord<String,String>, Long, ConsumerRecord<String,String>>() {
									private static final long serialVersionUID = 1L;

									@Override
									public Tuple2<Long, ConsumerRecord<String, String>> call(ConsumerRecord<String, String> consumer)
											throws Exception {
										String log = consumer.value();
										String[] logSplited = log.split(" ");
										long userid = Long.valueOf(logSplited[3]);
										return new Tuple2<Long, ConsumerRecord<String,String>>(userid, consumer);
									}
								});
						...
						JavaPairRDD<Long, Tuple2<ConsumerRecord<String, String>, Optional<Boolean>>> joinedRDD =
								mappedRDD.leftOuterJoin(blacklistRDD);
						
						JavaPairRDD<Long, Tuple2<ConsumerRecord<String, String>, Optional<Boolean>>> filteredRDD =
								joinedRDD.filter(
										new Function<Tuple2<Long,Tuple2<ConsumerRecord<String,String>,Optional<Boolean>>>, Boolean>() {
											private static final long serialVersionUID = 1L;

											@Override
											public Boolean call(
													Tuple2<Long, Tuple2<ConsumerRecord<String, String>, Optional<Boolean>>> tuple)
													throws Exception {
						...
						JavaPairRDD<String, String> resultRDD = filteredRDD.mapToPair(
								new PairFunction<Tuple2<Long,Tuple2<ConsumerRecord<String,String>,Optional<Boolean>>>, String, String>() {
									...
									public Tuple2<String, String> call(
											Tuple2<Long, Tuple2<ConsumerRecord<String, String>, Optional<Boolean>>> tuple)
											throws Exception {
										return new Tuple2<String, String>(tuple._2._1.key(), tuple._2._1.value());
									}
								});
		...
		JavaPairDStream<String, Long> blacklistDStream = dailyUserAdClickCountDStream
				.filter(new Function<Tuple2<String, Long>, Boolean>() {
					...
					public Boolean call(Tuple2<String, Long> tuple) throws Exception {
						...
						long clickCount = DAOFactory.getAdUserClickCountDAO().findClickCountByMultiKey(date, userId,
								adId);
